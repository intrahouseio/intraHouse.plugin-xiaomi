...
class Xiaomi extends EventEmitter {
  constructor(options) {
    ...
    this.options = {
      ...
      alarm_volume: options.alarm_volume || 70,
      doorbell_volume: options.doorbell_volume || 60,
      radio_volume: options.radio_volume || 20,
      gateway_volume: options.gateway_volume || 40,
    }
